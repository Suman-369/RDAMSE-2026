...
const Nav = () => {
  ...
  const navItems = [
    ...
    { name: "Conference Proceeding", path: "/conference-proceeding" },
  ...
  return (
    <header
      ref={navContainerRef}
      className="fixed top-4 md:top-8 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-full opacity-0"
    >
      {/* Main Navbar Container */}
      <nav
        className={`rounded-full p-2 flex items-center justify-between relative transition-all duration-300 ${
          isHome
      ...
      >
            ...
            {navItems.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-3 xl:px-5 py-2.5 rounded-full text-[13px] font-semibold transition-colors duration-300 flex items-center gap-2 z-10 cursor-pointer ${
                ...
                >
                  ...
                  {item.badge && (
                    <span
                      className={`flex items-center justify-center w-[22px] h-[22px] rounded-full text-[11px] font-extrabold pb-[1px] transition-colors duration-300 ${
                        isHome
                          ? isActive
        ...
        <div className="lg:hidden flex items-center justify-between w-full px-4 py-2">
          <span
            className={`text-lg font-bold px-2 py-1 ${isHome ? "text-white" : "text-gray-900"}`}
          >
            {activeTab === "Home" ? (
              <img src={rdamselogo} alt="Home" className="h-8 object-contain" />
            ) : (
              activeTab
            )}
          </span>
            ...
            return (
              <button
                ...
                className={`px-5 py-4 rounded-2xl text-base font-bold transition-colors flex items-center justify-between cursor-pointer ${
                  isHome
                    ? isActive
                      ? "bg-[#4ade80]/40 text-white border border-[#4ade80]/50"
                      : "text-white/80 hover:bg-white/10 hover:text-white"
                    : isActive
                      ? "bg-[#b8f29d] text-black"
              ...
              >
                ...
                {item.badge && (
                  <span
                    className={`flex items-center justify-center w-6 h-6 rounded-full text-[12px] font-extrabold
