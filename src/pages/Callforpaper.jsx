...
const Callforpaper = () => {
  return (
    <div className="min-h-screen pt-32 pb-12 px-6 bg-[#fafafa] flex flex-col items-center justify-center">
      ...
      <h1 className="text-4xl md:text-6xl font-black text-gray-900 mb-6 drop-shadow-sm">Call For Papers</h1>
      <p className="text-gray-500 text-lg max-w-xl text-center">
        Submit your cutting-edge research and be part of the future of science and engineering. Find important dates and topics here.
      </p>
    </div>
  );
};
