...
const Submission = () => {
  return (
    <div className="min-h-screen pt-32 pb-12 px-6 bg-[#fafafa] flex flex-col items-center justify-center">
      ...
      <h1 className="text-4xl md:text-6xl font-black text-gray-900 mb-6 drop-shadow-sm">Submission</h1>
      <p className="text-gray-500 text-lg max-w-xl text-center">
        Access the paper submission portal to upload your manuscript and track your review status.
      </p>
    </div>
  );
};
